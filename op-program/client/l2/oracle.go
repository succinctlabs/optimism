...
// L2PreimageOracle adds the L2 specific things to the preimage oracle
type L2PreimageOracle struct {
	PreimageOracle
}

func (p *L2PreimageOracle) OutputByRoot(l2OutputRoot common.Hash) eth.Output {
