...
func (_L2OutputOracle *L2OutputOracleCaller) ChainId(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _L2OutputOracle.contract.Call(opts, &out, "chainId")
...
//
// Solidity: function chainId() view returns(uint256)
func (_L2OutputOracle *L2OutputOracleSession) ChainId() (*big.Int, error) {
	return _L2OutputOracle.Contract.ChainId(&_L2OutputOracle.CallOpts)
}

// ChainId is a free data retrieval call binding the contract method 0x9a8a0592.
//
// Solidity: function chainId() view returns(uint256)
func (_L2OutputOracle *L2OutputOracleCallerSession) ChainId() (*big.Int, error) {
	return _L2OutputOracle.Contract.ChainId(&_L2OutputOracle.CallOpts)
}
...
func (_L2OutputOracle *L2OutputOracleCaller) HistoricBlockHashes(opts *bind.CallOpts, arg0 *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _L2OutputOracle.contract.Call(opts, &out, "historicBlockHashes", arg0)
...
//
// Solidity: function historicBlockHashes(uint256 ) view returns(bytes32)
func (_L2OutputOracle *L2OutputOracleSession) HistoricBlockHashes(arg0 *big.Int) ([32]byte, error) {
	return _L2OutputOracle.Contract.HistoricBlockHashes(&_L2OutputOracle.CallOpts, arg0)
}

// HistoricBlockHashes is a free data retrieval call binding the contract method 0xa196b525.
//
// Solidity: function historicBlockHashes(uint256 ) view returns(bytes32)
func (_L2OutputOracle *L2OutputOracleCallerSession) HistoricBlockHashes(arg0 *big.Int) ([32]byte, error) {
	return _L2OutputOracle.Contract.HistoricBlockHashes(&_L2OutputOracle.CallOpts, arg0)
}
...
func (_L2OutputOracle *L2OutputOracleCaller) VerifierGateway(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _L2OutputOracle.contract.Call(opts, &out, "verifierGateway")
...
//
// Solidity: function verifierGateway() view returns(address)
func (_L2OutputOracle *L2OutputOracleSession) VerifierGateway() (common.Address, error) {
	return _L2OutputOracle.Contract.VerifierGateway(&_L2OutputOracle.CallOpts)
}

// VerifierGateway is a free data retrieval call binding the contract method 0xfb3c491c.
//
// Solidity: function verifierGateway() view returns(address)
func (_L2OutputOracle *L2OutputOracleCallerSession) VerifierGateway() (common.Address, error) {
	return _L2OutputOracle.Contract.VerifierGateway(&_L2OutputOracle.CallOpts)
}
...
func (_L2OutputOracle *L2OutputOracleCaller) Vkey(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _L2OutputOracle.contract.Call(opts, &out, "vkey")
...
//
// Solidity: function vkey() view returns(bytes32)
func (_L2OutputOracle *L2OutputOracleSession) Vkey() ([32]byte, error) {
	return _L2OutputOracle.Contract.Vkey(&_L2OutputOracle.CallOpts)
}

// Vkey is a free data retrieval call binding the contract method 0xc69b0eb1.
//
// Solidity: function vkey() view returns(bytes32)
func (_L2OutputOracle *L2OutputOracleCallerSession) Vkey() ([32]byte, error) {
	return _L2OutputOracle.Contract.Vkey(&_L2OutputOracle.CallOpts)
}
...
func (_L2OutputOracle *L2OutputOracleTransactor) CheckpointBlockHash(opts *bind.TransactOpts, _blockNumber *big.Int, _blockHash [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.contract.Transact(opts, "checkpointBlockHash", _blockNumber, _blockHash)
}

// CheckpointBlockHash is a paid mutator transaction binding the contract method 0xdbf33074.
//
// Solidity: function checkpointBlockHash(uint256 _blockNumber, bytes32 _blockHash) returns()
func (_L2OutputOracle *L2OutputOracleSession) CheckpointBlockHash(_blockNumber *big.Int, _blockHash [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.CheckpointBlockHash(&_L2OutputOracle.TransactOpts, _blockNumber, _blockHash)
}

// CheckpointBlockHash is a paid mutator transaction binding the contract method 0xdbf33074.
//
// Solidity: function checkpointBlockHash(uint256 _blockNumber, bytes32 _blockHash) returns()
func (_L2OutputOracle *L2OutputOracleTransactorSession) CheckpointBlockHash(_blockNumber *big.Int, _blockHash [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.CheckpointBlockHash(&_L2OutputOracle.TransactOpts, _blockNumber, _blockHash)
}
...
// Initialize is a paid mutator transaction binding the contract method 0xbed264f5.
//
// Solidity: function initialize(uint256 _submissionInterval, uint256 _l2BlockTime, uint256 _startingBlockNumber, uint256 _startingTimestamp, address _proposer, address _challenger, uint256 _finalizationPeriodSeconds, uint256 _chainId, bytes32 _vkey, bytes32 _startingOutputRoot, address _verifierGateway) returns()
func (_L2OutputOracle *L2OutputOracleTransactor) Initialize(opts *bind.TransactOpts, _submissionInterval *big.Int, _l2BlockTime *big.Int, _startingBlockNumber *big.Int, _startingTimestamp *big.Int, _proposer common.Address, _challenger common.Address, _finalizationPeriodSeconds *big.Int, _chainId *big.Int, _vkey [32]byte, _startingOutputRoot [32]byte, _verifierGateway common.Address) (*types.Transaction, error) {
	return _L2OutputOracle.contract.Transact(opts, "initialize", _submissionInterval, _l2BlockTime, _startingBlockNumber, _startingTimestamp, _proposer, _challenger, _finalizationPeriodSeconds, _chainId, _vkey, _startingOutputRoot, _verifierGateway)
}
...
func (_L2OutputOracle *L2OutputOracleSession) Initialize(_submissionInterval *big.Int, _l2BlockTime *big.Int, _startingBlockNumber *big.Int, _startingTimestamp *big.Int, _proposer common.Address, _challenger common.Address, _finalizationPeriodSeconds *big.Int, _chainId *big.Int, _vkey [32]byte, _startingOutputRoot [32]byte, _verifierGateway common.Address) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.Initialize(&_L2OutputOracle.TransactOpts, _submissionInterval, _l2BlockTime, _startingBlockNumber, _startingTimestamp, _proposer, _challenger, _finalizationPeriodSeconds, _chainId, _vkey, _startingOutputRoot, _verifierGateway)
}
...
// SetVKey is a paid mutator transaction binding the contract method 0x0a26674d.
//
// Solidity: function setVKey(bytes32 _vkey) returns()
func (_L2OutputOracle *L2OutputOracleTransactor) SetVKey(opts *bind.TransactOpts, _vkey [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.contract.Transact(opts, "setVKey", _vkey)
}

// SetVKey is a paid mutator transaction binding the contract method 0x0a26674d.
//
// Solidity: function setVKey(bytes32 _vkey) returns()
func (_L2OutputOracle *L2OutputOracleSession) SetVKey(_vkey [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.SetVKey(&_L2OutputOracle.TransactOpts, _vkey)
}

// SetVKey is a paid mutator transaction binding the contract method 0x0a26674d.
//
// Solidity: function setVKey(bytes32 _vkey) returns()
func (_L2OutputOracle *L2OutputOracleTransactorSession) SetVKey(_vkey [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.SetVKey(&_L2OutputOracle.TransactOpts, _vkey)
}
