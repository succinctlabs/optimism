...
contract ZKL2OutputOracle_Init is CommonTest {
    ...
    uint constant STARTING_L2_OUTPUT_TIMESTAMP = 1721925325;
    uint constant STARTING_L2_OUTPUT_BLOCK_NUMBER = 123163274;
    ...
    function setUp() public virtual override {
        ...
        super.enableZK(
            ...
            STARTING_L2_OUTPUT_TIMESTAMP,
            STARTING_L2_OUTPUT_BLOCK_NUMBER,
            SUBMISSION_INTERVAL,
...
contract ZKL2OutputOracle_Test is ZKL2OutputOracle_Init {
    ...
    function test_proposeWithZKProof_succeeds() external {
        vm.warp(block.timestamp + (zkL2OutputOracle.SUBMISSION_INTERVAL() * zkL2OutputOracle.L2_BLOCK_TIME()));
        ...
        uint L2_BLOCK_NUM = L1_BLOCK_NUM + zkL2OutputOracle.SUBMISSION_INTERVAL();
